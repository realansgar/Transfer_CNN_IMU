...
PAMAP2_BASEPATH = "PAMAP2/Protocol/"
...
OPPORTUNITY_LOCOMOTION_BASEPATH = "Opportunity_Locomotion/dataset/"
...
OPPORTUNITY_GESTURES_BASEPATH = "Opportunity_Gestures/dataset/"
OPPORTUNITY_GESTURES_FILENAMES = {f"S{i}-ADL{j}.dat" for i in range(1,5) for j in range(1,6)} | {f"S{i}-Drill.dat" for i in range(1,5)}
OPPORTUNITY_GESTURES_FILEPATHS = {DATASETS_BASEPATH + OPPORTUNITY_GESTURES_BASEPATH + filename for filename in OPPORTUNITY_GESTURES_FILENAMES}
OPPORTUNITY_GESTURES_MIN_MAX_FILEPATH = DATASETS_BASEPATH + OPPORTUNITY_GESTURES_BASEPATH + "gestures.min_max.json"
OPPORTUNITY_GESTURES_PREPROCESSED_FILENAME_SUFFIX = ".gestures.preprocessed.npy"

OPPORTUNITY_GESTURES_VAL_SET = {f"{DATASETS_BASEPATH}{OPPORTUNITY_GESTURES_BASEPATH}S{i}-ADL3.dat{OPPORTUNITY_GESTURES_PREPROCESSED_FILENAME_SUFFIX}" for i in [2,3]}
OPPORTUNITY_GESTURES_TEST_SET = {f"{DATASETS_BASEPATH}{OPPORTUNITY_GESTURES_BASEPATH}S{i}-ADL{j}.dat{OPPORTUNITY_GESTURES_PREPROCESSED_FILENAME_SUFFIX}" for i in [2,3] for j in [4,5]}
...
OPPORTUNITY_GESTURES = {
  "TRAIN_SET_FILEPATH": DATASETS_BASEPATH + OPPORTUNITY_GESTURES_BASEPATH + "gestures.train.npz",
  "VAL_SET_FILEPATH":   DATASETS_BASEPATH + OPPORTUNITY_GESTURES_BASEPATH + "gestures.val.npz",
  "TEST_SET_FILEPATH":  DATASETS_BASEPATH + OPPORTUNITY_GESTURES_BASEPATH + "gestures.test.npz",

  "TRAIN_SET": OPPORTUNITY_GESTURES_TRAIN_SET,
  "VAL_SET": OPPORTUNITY_GESTURES_VAL_SET,
  "TEST_SET": OPPORTUNITY_GESTURES_TEST_SET,

  "NAME": "OPPORTUNITY_GESTURES - CNN-IMU-2",
  "MODEL": "CNN_IMU",
  "NUM_SENSOR_CHANNELS": 93,
  "NUM_CLASSES": 18,
  "WINDOW_SIZE": 24,
...
ORDER_PICKING_A_BASEPATH = "Order_Picking/_DO/"
ORDER_PICKING_A_FILENAMES = [f"subject0{i:02d}.dat" for i in [4,11,17]]
ORDER_PICKING_A_FILEPATHS = [DATASETS_BASEPATH + ORDER_PICKING_A_BASEPATH + filename for filename in ORDER_PICKING_A_FILENAMES]
ORDER_PICKING_A_MIN_MAX_FILEPATH = DATASETS_BASEPATH + ORDER_PICKING_A_BASEPATH + "min_max.json"
...
ORDER_PICKING_A_TRAIN_VAL_SET_FILEPATHS = [(f"{DATASETS_BASEPATH}{ORDER_PICKING_A_BASEPATH}subject0{i:02d}.dat_subject0{j:02d}.dat.train.npz", f"{DATASETS_BASEPATH}{ORDER_PICKING_A_BASEPATH}subject0{k:02d}.dat.val.npz") for i,j,k in [(4,11,17), (4,17,11), (11,17,4)]]
...
ORDER_PICKING_A = {
  ...
  "TEST_SET_FILEPATH":  DATASETS_BASEPATH + ORDER_PICKING_A_BASEPATH + "windows.test.npz",

  "NAME": "ORDER_PICKING_A - CNN-IMU-2",
  "MODEL": "CNN_IMU",
  "NUM_SENSOR_CHANNELS": 27,
  "NUM_CLASSES": 8,
  "WINDOW_SIZE": 100,
...
ORDER_PICKING_B_BASEPATH = "Order_Picking/_NP/"
ORDER_PICKING_B_FILENAMES = [f"subject0{i:02d}.dat" for i in [4,14,15]]
ORDER_PICKING_B_FILEPATHS = [DATASETS_BASEPATH + ORDER_PICKING_B_BASEPATH + filename for filename in ORDER_PICKING_B_FILENAMES]
ORDER_PICKING_B_MIN_MAX_FILEPATH = DATASETS_BASEPATH + ORDER_PICKING_B_BASEPATH + "min_max.json"
...
ORDER_PICKING_B_TRAIN_VAL_SET_FILEPATHS = [(f"{DATASETS_BASEPATH}{ORDER_PICKING_B_BASEPATH}subject0{i:02d}.dat_subject0{j:02d}.dat.train.npz", f"{DATASETS_BASEPATH}{ORDER_PICKING_B_BASEPATH}subject0{k:02d}.dat.val.npz") for i,j,k in [(4,14,15), (4,15,14), (14,15,4)]]
...
ORDER_PICKING_B = {
  "TRAIN_SET_FILEPATH": ORDER_PICKING_A_TRAIN_VAL_SET_FILEPATHS[0][0],
  "VAL_SET_FILEPATH":   ORDER_PICKING_A_TRAIN_VAL_SET_FILEPATHS[0][1],
  "TEST_SET_FILEPATH":  DATASETS_BASEPATH + ORDER_PICKING_B_BASEPATH + "windows.test.npz",

  "NAME": "ORDER_PICKING_B - CNN-IMU-2",
  "MODEL": "CNN_IMU",
  "NUM_SENSOR_CHANNELS": 27,
  "NUM_CLASSES": 7,
  "WINDOW_SIZE": 100,
